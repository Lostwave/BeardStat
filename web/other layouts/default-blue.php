...
/**********************************************************************************************
 This is a blue-themed alteration to the default layout. All comments have been removed but
...
div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ color:#000022; font:12px Verdana, Arial, sans-serif; }

table.bssearchbox	{ background:#F0F0F5 url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; width:600px; border:1px solid #000055; }
td.bssearch_head	{ color:#FFFFFF; background:#0000AA url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x top left; font-size:14px; font-weight:bold; text-align:center; border:1px solid #000055; border-width:0 0 1px 0; }

table.bsdata		{ border:1px solid #000000; border-width:1px 0 0 1px; }
td.bsdata_head		{ color:#FFFFFF; background:#002266 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; font-weight:bold; text-align:center; border:1px solid #000000; border-width:0 1px 1px 0; }
...
td.bsdata2		{ background-color:#D0D0DD; }

div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ background:#EDEDFF url("<?php echo $img_dir; ?>bs_gfade.png") repeat-x bottom left; border:1px solid #005500; padding:5px; margin:0 5px 0 0; cursor:pointer; }
div.bstab_selected	{ color:#FFFFFF; background-color:#0000AA; font-weight:bold; }
div.bstab_highlight	{ background-color:#CCCCFF; }

table.bsstat_outer	{ border:1px solid #5599BB; background:#99C5DD url("<?php echo $img_dir; ?>bs_mfade.png") repeat-x top left; }
td.bsstat_inner		{ border:1px solid #5599BB; background:#F0F0F5 url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; padding:5px; }
td.bstab_outer		{  }
...
.bsheader_title		{ font-weight:bold; font-size:16px; color:#000022; border:1px solid #990000; border-width:0 0 1px 0; padding:0 0 1px 0; margin:0 0 5px 0; width:100%; }

.bsform			{ display:inline; }
.bstext			{ background:#FFFFFF url("<?php echo $img_dir; ?>bs_text.png") repeat-x top left; border:1px solid #000000; margin:0; }
.bsbutton		{ font-weight:bold; color:#FFFFFF; background:#000077 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; border:1px outset #444444; margin:0; }
.bsselect		{ border:1px solid #000000; margin:0; padding:0; }

a.bs			{ color:#0033DD; text-decoration:none; }
a.bs:hover		{ color:#888899; }
