...
/**********************************************************************************************
 This is a green-themed alteration to the default layout. All comments have been removed but
...
div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ color:#000000; font:12px Verdana, Arial, sans-serif; }

table.bssearchbox	{ background:#F0F0F0 url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; width:600px; border:1px solid #003300; }
td.bssearch_head	{ color:#FFFFFF; background:#007700 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x top left; font-size:14px; font-weight:bold; text-align:center; border:1px solid #003300; border-width:0 0 1px 0; }

table.bsdata		{ border:1px solid #000000; border-width:1px 0 0 1px; }
td.bsdata_head		{ color:#FFFFFF; background:#005500 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; font-weight:bold; text-align:center; border:1px solid #000000; border-width:0 1px 1px 0; }
...
div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ background:#EDFFED url("<?php echo $img_dir; ?>bs_gfade.png") repeat-x bottom left; border:1px solid #005500; padding:5px; margin:0 5px 0 0; cursor:pointer; }
div.bstab_selected	{ color:#FFFFFF; background-color:#004400; font-weight:bold; }
div.bstab_highlight	{ background-color:#AADDAA; }

table.bsstat_outer	{ border:1px solid #88DDDD; background:#77CCCC url("<?php echo $img_dir; ?>bs_mfade.png") repeat-x top left; }
td.bsstat_inner		{ border:1px solid #88DDDD; background:#F0F0F0 url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; padding:5px; }
td.bstab_outer		{  }
...
.bsheader_title		{ font-weight:bold; font-size:16px; color:#000000; border:1px solid #990000; border-width:0 0 1px 0; padding:0 0 1px 0; margin:0 0 5px 0; width:100%; }
...
.bsbutton		{ font-weight:bold; color:#FFFFFF; background:#003300 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; border:1px outset #444444; margin:0; }
.bsselect		{ border:1px solid #000000; margin:0; padding:0; }

a.bs			{ color:#007711; text-decoration:none; }
a.bs:hover		{ color:#889988; }
