...
/**********************************************************************************************
 This is a red-themed alteration to the default layout. All comments have been removed but the
...
div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ color:#220000; font:12px Verdana, Arial, sans-serif; }

table.bssearchbox	{ background:#F0EDED url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; width:600px; border:1px solid #770000; }
td.bssearch_head	{ color:#FFEDED; background:#930000 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x top left; font-size:14px; font-weight:bold; text-align:center; border:1px solid #770000; border-width:0 0 1px 0; }

table.bsdata		{ border:1px solid #000000; border-width:1px 0 0 1px; }
td.bsdata_head		{ color:#FFEDED; background:#540000 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; font-weight:bold; text-align:center; border:1px solid #000000; border-width:0 1px 1px 0; }
td.bsdata, td.bsdata2	{ background:#F0EDED url("<?php echo $img_dir; ?>bs_gfade.png") repeat-x bottom left; border:1px solid #000000; border-width:0 1px 1px 0; }
td.bsdata2		{ background-color:#D0BBBB; }

div.bstab_generic, div.bstab_selected, div.bstab_highlight
			{ background:#FFEDED url("<?php echo $img_dir; ?>bs_gfade.png") repeat-x bottom left; border:1px solid #550000; padding:5px; margin:0 5px 0 0; cursor:pointer; }
div.bstab_selected	{ color:#FFFFFF; background-color:#660000; font-weight:bold; }
div.bstab_highlight	{ background-color:#FFC4C4; }

table.bsstat_outer	{ border:1px solid #DD6666; background:#FF8888 url("<?php echo $img_dir; ?>bs_mfade.png") repeat-x top left; }
td.bsstat_inner		{ border:1px solid #DD6666; background:#F0EDED url("<?php echo $img_dir; ?>bs_search_mainbg.png") repeat-x bottom left; padding:5px; }
td.bstab_outer		{  }
...
.bschoose		{ color:#999999; }
div.bserror		{ border:2px solid #FF3333; color:#000000; background:#FFE9E9; text-align:center; padding:5px; width:320px; }
.bsheader_title		{ font-weight:bold; font-size:16px; color:#330000; border:1px solid #999999; border-width:0 0 1px 0; padding:0 0 1px 0; margin:0 0 5px 0; width:100%; }

.bsform			{ display:inline; }
.bstext			{ background:#FFF5F5 url("<?php echo $img_dir; ?>bs_text.png") repeat-x top left; border:1px solid #440000; margin:0; }
.bsbutton		{ font-weight:bold; color:#FFFFFF; background:#550000 url("<?php echo $img_dir; ?>bs_search_head.png") repeat-x bottom left; border:1px outset #444444; margin:0; }
.bsselect		{ border:1px solid #440000; margin:0; padding:0; }

a.bs			{ color:#BB2200; text-decoration:none; }
a.bs:hover		{ color:#998888; }
